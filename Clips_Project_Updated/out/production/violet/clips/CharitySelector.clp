...
(deffacts load-facts
    ...
    (current_fact (fact ngee_ann_cultural_centre_limited) (cf 0.1) (all_vars arts_and_heritage no_tax_deduct medium money   historical_and_cultural_conservation exist_long   sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high has_website   ))
    (current_fact (fact singapore_indian_fine_arts_society_the) (cf 0.1) (all_vars arts_and_heritage no_tax_deduct medium money   music_and_orchestras exist_long  gov_grants sub_fin_yes ratio_eff_high  sub_gov_not_req gov_rating_low has_website media_exposure  ))
    (current_fact (fact national_book_development_council_of_singapore_the) (cf 0.1) (all_vars arts_and_heritage  medium money   literary_arts exist_long  gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact singapore_clan_foundation) (cf 0.1) (all_vars arts_and_heritage  medium money   historical_and_cultural_conservation exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact the_esplanade_co_ltd) (cf 0.1) (all_vars arts_and_heritage  large money inkind  music_and_orchestras exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact the_dance_company_ltd) (cf 0.1) (all_vars arts_and_heritage  medium money   professional_contemporary_and_ethnic_dance exit_medium  gov_grants sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high has_website   ))
    (current_fact (fact cake_theatrical_productions_ltd) (cf 0.1) (all_vars arts_and_heritage no_tax_deduct medium money   theatre_and_dramatic_arts exist_long  gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact tampines_arts_troupe) (cf 0.1) (all_vars arts_and_heritage  small money   traditional_ethnic_performing_arts exist_long  gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_mid has_website media_exposure  ))
    (current_fact (fact spot_art_limited) (cf 0.1) (all_vars arts_and_heritage no_tax_deduct small money inkind  visual_arts exist_short  gov_grants sub_fin_no ratio_eff_low  sub_gov_not_req gov_rating_low has_website   ))
    (current_fact (fact radin_mas_ccc_community_development_and_welfare_fund) (cf 0.1) (all_vars community  medium money   central exist_long   sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact kaki_bukit_ccc_community_development_and_welfare_fund) (cf 0.1) (all_vars community  medium money   north_east exist_long  gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high  media_exposure  ))
    (current_fact (fact kebun_baru_ccc_community_development_and_welfare_fund) (cf 0.1) (all_vars community  small money   north_west exist_long   sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high  media_exposure  ))
    (current_fact (fact fengshan_ccc_community_development_and_welfare_fund) (cf 0.1) (all_vars community  small money   south_east exist_long   sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high  media_exposure  ))
    (current_fact (fact bukit_batok_ccc_community_development_and_welfare_fund) (cf 0.1) (all_vars community  medium money   south_west exist_long invest_reserves  sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact the_friends_of_the_university_of_warwick_in_singapore) (cf 0.1) (all_vars education  small money   foreign_educational_institutions_and_funds exist_short   sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_mid  media_exposure  ))
    (current_fact (fact methodist_schools_foundation) (cf 0.1) (all_vars education  medium money   foundations_and_trusts exist_long invest_reserves  sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website   ))
    (current_fact (fact hwa_chong_international_school_education_fund) (cf 0.1) (all_vars education  small money   local_educational_institutions_and_funds exist_long invest_reserves  sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website   ))
    (current_fact (fact girl_guides_singapore) (cf 0.1) (all_vars education  medium money  volunteer uniformed_groups exist_long  gov_grants sub_fin_yes ratio_eff_low  sub_gov_not_req gov_rating_low has_website media_exposure  ))
    (current_fact (fact national_skin_centre_health_endowment_fund) (cf 0.1) (all_vars health  small money   cluster_and_hospital_funds exist_long invest_reserves  sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high    ))
    (current_fact (fact ren_ci_hospital) (cf 0.1) (all_vars health  large money inkind volunteer community_and_chronic_sick_hospital exit_medium invest_reserves gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure has_chequered past  ))
    (current_fact (fact sata_commhealth) (cf 0.1) (all_vars health no_tax_deduct large money  volunteer day_rehabilitation_centre exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact ronald_mcdonald_house_charities_singapore) (cf 0.1) (all_vars health no_tax_deduct medium money   diseases_and_illnessess_support_group exist_long invest_reserves  sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact academy_of_medicine_singapore) (cf 0.1) (all_vars health  large money   health_professional_group exist_long  gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact home_nursing_foundation) (cf 0.1) (all_vars health  large money  volunteer home_care exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact assisi_hospice) (cf 0.1) (all_vars health  large money  volunteer hospice exit_medium invest_reserves gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact hca_hospice_care) (cf 0.1) (all_vars health  large money  volunteer palliative_home_care exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact grace_lodge) (cf 0.1) (all_vars health  large money  volunteer nursing_home exist_long  gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact alzheimers_disease_association) (cf 0.1) (all_vars health  large money  volunteer community_based_services exist_long  gov_grants sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact kidney_dialysis_foundation_limited) (cf 0.1) (all_vars health  large money  volunteer renal_dialysis exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact public_free_clinic_society) (cf 0.1) (all_vars health  large money  volunteer tcm_clinic exist_long invest_reserves  sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact alexandra_health_fund_limited) (cf 0.1) (all_vars health  medium money  volunteer trust_and_research_funds exist_short invest_reserves  sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high  media_exposure  ))
    (current_fact (fact society_for_the_prevention_of_cruelty_to_animals_singapore) (cf 0.1) (all_vars others  medium money inkind volunteer animal_welfare exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact blossom_world_society) (cf 0.1) (all_vars others  medium money   children_and_youth exist_short  gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact waterways_watch_society) (cf 0.1) (all_vars others  medium money   environment exist_long  gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_mid has_website media_exposure  ))
    (current_fact (fact asia_pacific_breweries_foundation) (cf 0.1) (all_vars others  medium money  volunteer general_charitable_purposes exist_long invest_reserves  sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_mid has_website media_exposure  ))
    (current_fact (fact the_law_society_of_singapore_pro_bono_learning_and_support_services) (cf 0.1) (all_vars others  medium money   humanitarian_aid exist_long  gov_grants sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact singapore_indian_development_association_sinda) (cf 0.1) (all_vars others  large money  volunteer self_help_groups exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact singapore_institute_of_international_affairs_endowment_fund) (cf 0.1) (all_vars others  medium money   think_tanks exist_long   sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact singapore_buddhist_federation_the) (cf 0.1) (all_vars religious no_tax_deduct medium money  volunteer buddhism exist_long  gov_grants sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact new_creation_church) (cf 0.1) (all_vars religious no_tax_deduct large money  volunteer christianity exist_long  gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_mid has_website media_exposure  ))
    (current_fact (fact holy_tree_sri_bala_subramaniar_temple) (cf 0.1) (all_vars religious no_tax_deduct medium money  volunteer hinduism exist_long   sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact muslim_converts_association_of_singapore) (cf 0.1) (all_vars religious no_tax_deduct medium money  volunteer islam exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact xian_gu_tian) (cf 0.1) (all_vars religious no_tax_deduct medium money   taoism exist_long   sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high    ))
    (current_fact (fact fei_yue_community_services) (cf 0.1) (all_vars social_and_welfare  large money  volunteer children_and_youth exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact caritas_singapore_agape_fund) (cf 0.1) (all_vars social_and_welfare no_tax_deduct large money   community exist_long invest_reserves  sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact association_for_persons_with_special_needs) (cf 0.1) (all_vars social_and_welfare  large money inkind volunteer disability_adult exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_mid has_website media_exposure  ))
    (current_fact (fact apex_day_rehabilitation_centre_for_elderly) (cf 0.1) (all_vars social_and_welfare  medium money  volunteer eldercare exist_long  gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website   ))
    (current_fact (fact family_life_society) (cf 0.1) (all_vars social_and_welfare  medium money  volunteer family exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact heb___ashram_halfway_house) (cf 0.1) (all_vars social_and_welfare  medium money   support_groups exit_medium  gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact footballplus_ltd) (cf 0.1) (all_vars sports  small money   competitive_sports exist_short  gov_grants sub_fin_yes ratio_eff_high fin_health_poor sub_gov_yes gov_rating_mid has_website   ))
    (current_fact (fact singapore_national_paralympic_council_ltd) (cf 0.1) (all_vars sports  medium money   disability_sports exit_medium  gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact special_olympics_asia_pacific_ltd) (cf 0.1) (all_vars sports no_tax_deduct large money inkind  non_nsas exit_medium   sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high  media_exposure  ))
    (current_fact (fact singapore_athletic_association) (cf 0.1) (all_vars sports no_tax_deduct medium money inkind volunteer nsas exit_medium  gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    (current_fact (fact salvation_army_the) (cf 0.1) (all_vars social_and_welfare  large money inkind volunteer community exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_mid has_website media_exposure  ))
