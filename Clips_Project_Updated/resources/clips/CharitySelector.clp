...
(deffacts load-facts
    ...
    (current_fact (fact fengshan_ccc_community_development_and_welfare_fund) (cf 0.5) (all_vars community  small money   south_east exist_long   sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high  media_exposure  ))
    ...
    (current_fact (fact public_free_clinic_society) (cf 0.5) (all_vars health  large money  volunteer tcm_clinic exist_long invest_reserves  sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    ...
    (current_fact (fact singapore_buddhist_federation_the) (cf 0.5) (all_vars religious no_tax_deduct medium money  volunteer buddhism exist_long  gov_grants sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_high has_website media_exposure  ))
    ...
    (current_fact (fact holy_tree_sri_bala_subramaniar_temple) (cf 0.5) (all_vars religious no_tax_deduct medium money  volunteer hinduism exist_long   sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website media_exposure  ))
    ...
    (current_fact (fact fei_yue_community_services) (cf 0.5) (all_vars social_and_welfare  large money  volunteer children_and_youth exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_med  sub_gov_yes gov_rating_high has_website media_exposure  ))
    ...
    (current_fact (fact association_for_persons_with_special_needs) (cf 0.5) (all_vars social_and_welfare  large money inkind volunteer disability_adult exist_long invest_reserves gov_grants sub_fin_yes ratio_eff_high  sub_gov_yes gov_rating_mid has_website media_exposure  ))
    (current_fact (fact apex_day_rehabilitation_centre_for_elderly) (cf 0.5) (all_vars social_and_welfare  medium money  volunteer eldercare exist_long  gov_grants sub_fin_yes ratio_eff_low  sub_gov_yes gov_rating_high has_website   ))
