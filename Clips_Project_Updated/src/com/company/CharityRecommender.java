...
public class CharityRecommender {
    ...
    private Hashtable religion_hash = new Hashtable();
    private Hashtable sector_preference_hash = new Hashtable();
    ...
    public void continueInterview() throws CLIPSException {
        ...
        switch (relationAsserted) {
            ...
            case "tax_exemption":
			    ...
			    break;
			case "religion":
				answers = (Vector<String>) religion_hash.get(theAnswer);
				variableAsserts.addAll(answers);
                break;
			case "sector_preference":
				answers = (Vector<String>) sector_preference_hash.get(theAnswer);
				variableAsserts.addAll(answers);
				break;	
        }
        processRules();
